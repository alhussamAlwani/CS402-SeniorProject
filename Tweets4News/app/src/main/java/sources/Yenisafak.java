...
public class Yenisafak extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            URL url = new URL("http://alhussamalwani.pagekite.me/android_login_api/newsTitleYenisafak.txt");
            BufferedReader bfr = new BufferedReader(new InputStreamReader(url.openStream()));

            //BufferedReader bfr = new BufferedReader(new InputStreamReader(getAssets().open("newsTitleYenisafak.txt")));
