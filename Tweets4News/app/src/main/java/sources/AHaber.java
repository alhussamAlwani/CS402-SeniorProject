...
public class AHaber extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            URL url = new URL("http://alhussamalwani.pagekite.me/android_login_api/newsTitleAHaber.txt");
            BufferedReader bfr = new BufferedReader(new InputStreamReader(url.openStream()));

            //BufferedReader bfr = new BufferedReader(new InputStreamReader(getAssets().open("newsTitleAHaber.txt")));
