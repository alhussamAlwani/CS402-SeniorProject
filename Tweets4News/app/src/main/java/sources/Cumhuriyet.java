...
public class Cumhuriyet extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            URL url = new URL("http://alhussamalwani.pagekite.me/android_login_api/newsTitleCumhuriyet.txt");
            BufferedReader bfr = new BufferedReader(new InputStreamReader(url.openStream()));

            //BufferedReader bfr = new BufferedReader(new InputStreamReader(getAssets().open("newsTitleCumhuriyet.txt")));
